...
const maybeRenderNestedStack = (options, route, renderScene, stackPresentation, isHeaderInModal, viewStyles) => {
  if (isHeaderInModal) {
...
function NativeStackView({
  ...
  return /*#__PURE__*/React.createElement(_reactNativeScreens.ScreenStack, {
    ...
    const viewStyles = [styles.container, stackPresentation !== 'transparentModal' && stackPresentation !== 'containedTransparentModal' && {
    ...
    })), maybeRenderNestedStack(options, route, renderScene, stackPresentation, isHeaderInModal, viewStyles));
  }));
}
